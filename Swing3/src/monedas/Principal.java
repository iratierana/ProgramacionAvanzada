...
public class Principal implements ActionListener {
	...
	private Component dameMonedaCambiada() {
		...
		resultado.setBorder(BorderFactory.createTitledBorder(BorderFactory.createBevelBorder(0, Color.LIGHT_GRAY, Color.white), "Cantidad",
	...
	private Component meteCantidad() {
		...
		texto.setBorder(BorderFactory.createTitledBorder(BorderFactory.createBevelBorder(0, Color.LIGHT_GRAY, Color.white), "Cantidad",
				0, 0, (new Font("arial", Font.BOLD, 12)), Color.black));
	...
	private Component crearAbajo(){
		String nameBoton = "Mostrar cambio";
